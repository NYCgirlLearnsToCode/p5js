...
function draw() {
  ...
  for(var i = 0; i <=width; i+= 60){
    for (var j = 0; j <= height; j+= 60){
      fill(mouseX, random(255), mouseY);// changed random to 30 to minimize color range so it flickers slower and doesnt give me 
      rect(i, j, 35, 35);// width changed to 100 for rectangle shape 
